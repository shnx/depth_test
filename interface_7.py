            ...
            if grid_overlay_var.get():
                for i in range(1, 4):  # 3x3 grid
                    for j in range(1, 4):
                        ...
                        # Optionally, add depth values here
                        # depth_value = depth_frame_data[y, x]  # Fetch depth at grid points
                        # cv2.putText(frame, f"{depth_value}", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
