...
# Start GUI in separate thread and run main loop for robot control
if __name__ == "__main__":
    run_gui()  # Run GUI for Z-axis movement control
    main()     # Start the main loop for robot control and video feed
